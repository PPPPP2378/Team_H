 ...
 */
public class BearAI_Complete : MonoBehaviour
{
    [Header("移動設定")]
    ...
    public int scoreValue = 400; // 倒したときのスコア値
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning("BearAI: Waypoint も Target も見つかりませんでした。");
        }
    }
    ...
    // すべての熊を削除
    public static void RemoveAllBears()
    {
